...
<div class="wrap couponis7k-wrap">
    ...
    <div class="couponis7k-stats-row">
        ...
        <div class="couponis7k-stat-box couponis7k-stat-primary">
            ...
            <div class="couponis7k-stat-label"><?php _e('Publicados', '7k-coupons-importer'); ?></div>
        </div>
                ...
                <div class="couponis7k-coupon-card" data-coupon-id="<?php echo esc_attr($coupon_id); ?>">
                    ...
                    <div class="couponis7k-coupon-content">
                        ...
                        <div class="couponis7k-coupon-meta">
                            <?php if ($advertiser): ?>
                                <span><strong><?php _e('Loja:', '7k-coupons-importer'); ?></strong> <?php echo esc_html($advertiser); ?></span>
                            <?php endif; ?>
                            <?php if ($code): ?>
                                <span><strong><?php _e('Código:', '7k-coupons-importer'); ?></strong> <code><?php echo esc_html($code); ?></code></span>
                            <?php endif; ?>
                            <?php if ($expiration): ?>
