...
if (isset($_POST['ci7k_save_store_mapping'])) {
    ...
    $original = sanitize_text_field($_POST['original_store']);
    $mapped = sanitize_text_field($_POST['mapped_store']);
...
if (isset($_POST['ci7k_save_category_mapping'])) {
    ...
    $mapped = sanitize_text_field($_POST['mapped_category']);
...
if (isset($_POST['ci7k_delete_store_mapping'])) {
    ...
    $original = sanitize_text_field($_POST['delete_store']);
...
if (isset($_POST['ci7k_delete_category_mapping'])) {
    ...
    $original = sanitize_text_field($_POST['delete_category']);
            ...
            <form method="post" class="ci7k-mapping-form">
                ...
                <table class="form-table">
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" name="mapped_store" required class="regular-text" placeholder="<?php _e('Nome da loja no WordPress', '7k-coupons-importer'); ?>">
                            <p class="description"><?php _e('Digite o nome que deseja usar no WordPress', '7k-coupons-importer'); ?></p>
                        </td>
                    </tr>
                </table>
            ...
            <form method="post" class="ci7k-mapping-form">
                ...
                <table class="form-table">
                    ...
                    <tr>
                        <th><?php _e('Mapear Para', '7k-coupons-importer'); ?></th>
                        <td>
                            <input type="text" name="mapped_category" required class="regular-text" placeholder="<?php _e('Nome da categoria no WordPress', '7k-coupons-importer'); ?>">
                            <p class="description"><?php _e('Digite o nome que deseja usar no WordPress', '7k-coupons-importer'); ?></p>
                        </td>
                    </tr>
                </table>
